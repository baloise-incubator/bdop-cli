...
from bdop_cli.io_api.tmp_dir import create_tmp_dir, delete_tmp_dir
...
class TmpDirTest(unittest.TestCase):
    ...
    def test_create_tmp_dir(self):
        ...
        self.assertRegex(
            self.tmp_dir, r"^/tmp/bdop-cli/[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$"
        )
        self.assertTrue(os.path.isdir(self.tmp_dir))

    def test_delete_tmp_dir(self):
        self.tmp_dir = f"/tmp/bdop-cli/{uuid.uuid4()}"
