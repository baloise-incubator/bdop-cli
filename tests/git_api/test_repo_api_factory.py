...
from bdop_cli.git_api import GitRepoApiFactory, GitApiConfig, GitProvider


class GitRepoApiFactoryTest(unittest.TestCase):
    @patch("bdop_cli.git_api.git_repo_api_factory.GitRepoApiLoggingProxy")
    @patch("bdop_cli.git_api.git_repo_api_factory.GithubGitRepoApiAdapter")
    ...
    @patch("bdop_cli.git_api.git_repo_api_factory.GitRepoApiLoggingProxy")
    @patch("bdop_cli.git_api.git_repo_api_factory.BitbucketGitRepoApiAdapter")
    ...
    @patch("bdop_cli.git_api.git_repo_api_factory.GitRepoApiLoggingProxy")
    @patch("bdop_cli.git_api.git_repo_api_factory.GitlabGitRepoApiAdapter")
