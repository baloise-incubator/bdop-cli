...
from bdop_cli.git_api import GitRepoApi
from bdop_cli.git_api.git_repo_api_logging_proxy import GitRepoApiLoggingProxy
...
class GitRepoApiLoggingProxyTest(unittest.TestCase):
    ...
    @patch("bdop_cli.git_api.git_repo_api_logging_proxy.logging")
