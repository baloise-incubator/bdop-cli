...
from bdop_cli.git_api import GitProvider, GitRepo, GitRepoApi, GitRepoApiFactory
from bdop_cli.commands.sync_apps import SyncAppsCommand
from bdop_cli.io_api.yaml_util import yaml_file_load, yaml_file_dump
...
class SyncAppsCommandTest(MockMixin, unittest.TestCase):
    def setUp(self):
        ...
        patcher = patch("bdop_cli.appconfig_api.app_tenant_config.os", spec_set=os)
        ...
        patcher = patch("bdop_cli.appconfig_api.root_repo.yaml_file_load", spec_set=yaml_file_load)
        self.addCleanup(patcher.stop)
            ...
            call.yaml_file_dump(
                {
                    "config": {
                        "repository": "https://repository.url/team/team-non-prod.git",
                        "applications": {"my-app": ordereddict()},
                    }
                },
                "/tmp/root-config-repo/apps/team-non-prod.yaml",
            ),
